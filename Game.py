...
if answer.lower().strip() == "yes":
    answer = input("Welcome to the Game, You come accross a two way street. Which way do you want to go (left/right)")
    if answer == "left" :
        answer = input("You were walking and encountered a monster. Do you want to attack or run?(attack/run)")
        if  answer == "attack" :
        ...
        answer = input("You are in a garden. You saw fruits. Do you want to eat or let go (eat/let go)")
        if answer == "eat":
